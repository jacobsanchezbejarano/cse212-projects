...
public static class SetsAndMapsTester
{
    ...
    private static void DisplayPairs(string[] words)
    {
        ...
        {
            string compare = $"{word[1]}{word[0]}";
            if (set1.Contains(compare)) Console.WriteLine($"{word} & {compare}");
            set1.Add(word);
        }
    }
    ...
    private static bool IsAnagram(string word1, string word2)
    {
        ...
        {
            if (!dict2.ContainsKey(c)) return false;
    ...
    private static void EarthquakeDailySummary()
    {
        ...
        foreach (var data in featureCollection.Features)
        {
            ...
            Console.WriteLine($"{props.Place} - Mag {props.Mag}");
        }
    }
}