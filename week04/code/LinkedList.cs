...
public class LinkedList : IEnumerable<int>
{
    ...
    public void InsertTail(int value)
    {
        ...
        // If the tail is empty, then point both head and tail to the new node.
        else if (_tail is null)
        {
            _tail = newNode;
        }
        // If the list is not empty and the tail is not empty, then only tail will be affected.
        else
        {
    ...
    public void Remove(int value)
    {
        ...
        while (curr is not null)
        {
            if (curr.Data == value)
            {
                ...
                {
                    curr.Prev.Next = curr.Next; // Disconect the value from the previous element
                    curr.Next.Prev = curr.Prev; // Disconect the value from the next element
                    return;
                }
            }
